...
##tests - not sure...
#test <- table(
#  tr_r_gq_10[!is.na(tr_e_gq),tract],
#  tr_r_gq_10[!is.na(tr_e_gq),gq_type],
#  tr_r_gq_10[!is.na(tr_e_gq),gq_specs]
#)==table(
#  tr_e_gq_10[,tract],
#  tr_e_gq_10[,gq_type],
#  tr_e_gq_10[,gq_specs]
...
#  tr_r_gq_over17_10[!is.na(tr_e_gq),sex],
#  tr_r_gq_over17_10[!is.na(tr_e_gq),gq_type]
#)==table(
#  tr_e_gq_over17_10[,tract],
#  tr_e_gq_over17_10[,sex],
#  tr_e_gq_over17_10[,gq_type]
#)
#length(test[test==FALSE])==0
#then add something to the blanks so we know what they might have been??? Is that a density?
#table(tr_r_gq_over17_10$tr_e_gq)
...
Do the match_ids have NA just in them in a way that allows them to match sometimes? 
...
This feels very much like the ones where we're not sure of how the sex and gq_specs distribute is really the point

```{r finish matching over17 and full gq types and specs}
test <- table(tr_r_gq_10[!is.na(sex),tract])==
  table(tr_r_gq_over17_10[,tract])

#if it has sex, then it's over_17 for age...
```
