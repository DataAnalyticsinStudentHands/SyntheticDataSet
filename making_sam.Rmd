...
tr_e_gq_10[,("tr_e_count"):=.N,by=c("tract","re_code","gq_type","gq_specs")]
...
tr_e_gq_10[re_code=="I",("tr_r_gq_match_id"):=
                    paste0(tract,gq_type,gq_specs,as.character(100000+sample(1:.N))),
                  by=.(tract,gq_type,gq_specs)]
tr_r_gq_10[re_code=="A",c("tr_e_gq","tr_e_gq_count"):=
                    tr_e_gq_10[.SD, c(list(re_code),list(as.integer(tr_e_count))), on = .(tr_r_gq_match_id)]]
...
tr_e_gq_10[is.na(matched),("tr_r_gq_match2_id"):=
                    paste0(tract,gq_type,gq_specs,as.character(100000+sample(1:.N))),
                  by=.(tract,gq_type,gq_specs)]
tr_r_gq_10[is.na(tr_e_gq),c("tr_e_gq","tr_e_gq_count"):=
                    tr_e_gq_10[.SD, c(list(re_code),list(as.integer(tr_e_count))), on = .(tr_r_gq_match2_id)]]
nrow(tr_r_gq_10[!is.na(tr_e_gq)])
nrow(tr_r_gq_10[!is.na(tr_e_gq_count)])
##tests
test <- table(
...
table(tr_r_gq_10$tr_e_gq)
tr_r_gq_10[,c("tr_e_gq","tr_e_gq_count"):=
             .SD[1,c(list(tr_e_gq),list(as.integer(tr_e_gq_count)))],
           by = .(tract,re_code,gq_type,gq_specs)]
table(tr_r_gq_10$tr_e_gq)
```
...
tr_e_gq_over17_10[,("tr_e_count"):=.N,by=c("tract","re_code","sex","gq_type")]
...
tr_e_gq_over17_10[re_code=="I",("tr_r_gq_match_id"):=
                    paste0(tract,sex,gq_type,as.character(100000+sample(1:.N))),
                  by=.(tract,sex,gq_type)]
tr_r_gq_over17_10[re_code=="A",c("tr_e_gq","tr_e_gq_count"):=
                    tr_e_gq_over17_10[.SD, 
                                      c(list(re_code),list(as.integer(tr_e_count))), 
                                      on = .(tr_r_gq_match_id)]]
...
tr_e_gq_over17_10[is.na(matched),("tr_r_gq_match2_id"):=
                    paste0(tract,sex,gq_type,as.character(100000+sample(1:.N))),
                  by=.(tract,sex,gq_type)]
tr_r_gq_over17_10[is.na(tr_e_gq),c("tr_e_gq","tr_e_gq_count"):=
                    tr_e_gq_over17_10[.SD, 
                                      c(list(re_code),list(as.integer(tr_e_count))), 
                                      on = .(tr_r_gq_match2_id)]]
nrow(tr_r_gq_over17_10[!is.na(tr_e_gq)])
nrow(tr_r_gq_over17_10[!is.na(tr_e_gq_count)])
##tests
test <- table(
...
tr_r_gq_over17_10[,c("tr_e_gq","tr_e_gq_count"):=
             .SD[1,c(list(tr_e_gq),list(as.integer(tr_e_gq_count)))],
           by = .(tract,re_code,gq_type)]
table(tr_r_gq_over17_10$tr_e_gq)
```

Now let's see what we can do to add the two versions of the race and ethnicity files together, and to see how it might point to a better final construction. The first part is to use the broad age range by sex and group quarter specifications
...
tr_r_gq_10[,c("sex_tr17_r","tr_e_sa_gq","tr_e_sa_gq_count"):=
             .SD[1,c(list(sex_tr17_r),list(tr_e_sa_gq),list(as.integer(tr_e_sa_gq_count)))],
           by = .(tract,re_code,gq_type)]
table(tr_r_gq_10$tr_e_sa_gq)-test

```

Let's look at these and see what the strategy is for reduction - should have some way that some of the combinations are eliminated,
for instance - maybe just a [if not both with temp, then not listed as possible for next??]
