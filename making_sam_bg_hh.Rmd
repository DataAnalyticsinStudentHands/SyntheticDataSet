...
Followed below - can't remember why I left it in all caps.
...
tr_r_gq_10[order(tract,re_code,institutionalized,gq_type,gq_specs), #test to see what's needed
            ("gq_spec_count_r"):=.N,
            by=c("tract","re_code","institutionalized","gq_type","gq_specs")]
tr_r_gq_over17_10[,("bg_r_gq_17_match_id"):=
                    paste0(tract,re_code,gq_type,as.character(100000+sample(1:.N))),
                  by=.(tract,re_code,gq_type)]
tr_r_gq_10[,("bg_r_gq_17_match_id"):=
                    paste0(tract,re_code,gq_type,as.character(100000+sample(1:.N))),
                  by=.(tract,re_code,gq_type)]
...
test <- summary(tr_r_gq_10[,gq_spec_count_r])==
