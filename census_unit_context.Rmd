...
censusblocks <- block_race[censusblocks,on = "GEOID"] #avoids shallow copy problem
```
...
censusblocks[,("pop_area"):=Total/ALAND]
library(ggplot2)
ggplot(censusblocks, aes(x=ALAND,y=Total)) + geom_point()
```
