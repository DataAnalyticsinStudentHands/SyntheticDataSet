...
```
#Do I need this? Try with and without...
```{css, echo=FALSE}
table {
  margin: auto;
...
censusblocks <- block_race[censusblocks,on = "GEOID"] 
```
...
censusblocks[,("pop_density_sq_km"):=round((Total/ALAND)*1000000)] #people per square kilometer
pop_density_Harris <- st_as_sf(censusblocks[!is.na(STATEFP),
                                      c("Total","pop_density_sq_km",
...
#do the matching with ethnicity from other making_Sam.RMD
