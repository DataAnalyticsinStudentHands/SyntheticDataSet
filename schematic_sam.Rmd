...
#library(dplyr)
library(tidyr) #what am I using from tidy?
library(data.table)
library(stringr)
...
trSAR_dec_data_from_census <- 
  census_tract_get(censusdir, vintage, state, censuskey, 
                         groupname = "PCT12",county,
                         api_type="dec/dhc",path_suff="est") #dec/sf1 for 2010!!
