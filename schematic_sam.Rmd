...
Do sare, bgSARE with specifications from P! and PCT
Do household
...
dt <- as.data.table(list(unique(bgSARE_dec$re_code),unique(bgSARE_dec$concept)))
...
```{r table for race and re_code and test for zeros}
test_table <- table(bgSARE$re_code,bgSARE$race)
test_table
```
