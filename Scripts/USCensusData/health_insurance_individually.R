...
vars <- c("B18135_005E","B18135_006E","B18135_007E",paste0("B18135_0",10:12,"E"),paste0("B18135_0",16:18,"E"),paste0("B18135_0",21:23,"E"),paste0("B18135_0",27:29,"E"),paste0("B18135_0",32:34,"E"))
# Get data for all census tracts in TX21
...
write.csv(census_data, file = "health_insurance_not_by_household_income.csv",row.names=FALSE, na="", quote = FALSE)