...
vars <- c("B08014_009E","B08014_010E","B08014_011E","B08014_012E","B08014_013E","B08014_014E",paste0("B08014_0",16:21,"E"))
...
write.csv(census_data, file = "vehicles_for_group_quarters.csv",row.names=FALSE, na="", quote = FALSE)