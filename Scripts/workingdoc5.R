#group quarter alternate functions


#Get number of vehicles available

getnumberofvehiclesforgroupquarters <- function(county, tract,syntheticdataset,seed,Census_data_List){
...
getincomeforgroupquarters <- function(county, tract,syntheticdataset,seed,Census_data_List){
  #Generates number of vehicles per household
...
gethealthinsuranceforgroupquarters <- function(county, tract,syntheticdataset,seed,Census_data_List){
  #Generates number of vehicles per household
