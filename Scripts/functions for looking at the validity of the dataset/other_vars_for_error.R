...
vars <- c("B23025_004E","B23025_005E","B23025_006E","B23025_007E","B05002_002E","B05002_013E","B06007_002E","B06007_004E","B06007_005E","B08113_002E","B06007_003E","B06007_006E","B21001_002E","B21001_003E")
cols1=c("state","county","tract","employment_Employed","employment_Unemployed","employment_In Armed Forces" ,"employment_Not in labor force","nativity_Native","nativity_Foreign")
cols2=c("English.speaking.skills_Speaks Only English","English.speaking.skills_Speaks English Very Well","English.speaking.skills_Speaks English Not Very Well")
cols3=c("Language.at.home_English","Language.at.home_Speaks Spanish","Language.at.home_Speaks Other Languages","veteran.status_Veteran","veteran.status_Nonveteran" )
# Get data for all census tracts in TX
census_data <- getCensusApi(acs5_2014_api, key=key, vars, region="for=tract:*&in=state:48")

colnames(census_data)=c(cols1,cols2,cols3)
#write data frame to csv file without quotes
write.csv(census_data, file = "other_vars_for_error.csv",row.names=FALSE, na="", quote = FALSE)