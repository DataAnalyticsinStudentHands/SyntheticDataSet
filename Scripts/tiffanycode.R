...
acs5_2014_api <- 'http://api.census.gov/data/2015/acs5?'
#variables used B08119_001E
#Household size and number of vehicles
vars <- "B00001_001E"
#vars <- paste0("B08119_00",1:6,"E")
...
write.csv(census_data, file = "tiffany_data.csv",row.names=FALSE, na="", quote = FALSE)