...
acs5_2014_api <- 'http://api.census.gov/data/2014/acs5/profile?'
#variables used
#Household size and number of vehicles
vars <- c("DP05_0002PE","DP05_0003PE")
names=c("state","county","tract","Male","Female",)
...
write.csv(census_data, file = "percents.csv",row.names=FALSE, na="", quote = FALSE)