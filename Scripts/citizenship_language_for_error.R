...
vars <- c("B16008_002E","B16008_020E","B16008_037E","B06007_002E","B06007_003E","B06007_006E")
#codes="Native","Naturalized Citizen","Not a U.S. Citizen","Speaks Only English","Speaks Spanish","Speaks Other Language"
# Get data for all census tracts in TX
census_data <- getCensusApi(acs5_2014_api, key=key, vars, region="for=tract:*&in=state:48")
colnames(census_data)=c("state","county","tract","Citizen","Naturalized Citizen","Not a U.S. Citizen","English","Speaks Spanish","Speaks Other Language")
#write data frame to csv file without quotes
write.csv(census_data, file = "citizenship_language_for_error.csv",row.names=FALSE, na="", quote = FALSE)