...
table(trHH_own_kids_tenure[,kids_age])-table(trHH_all_kids_tenure[,own_kids]) #about 100 didn't match (they must not have come from same modeled whole??)
#get that last 100 by letting them move on rent_own and under age
