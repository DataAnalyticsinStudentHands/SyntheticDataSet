...
getlangandnativity <- function(state, county,tract,syntheticdataset,seed,Census_data){
  ...
  codelangnat=ifelse(syntheticdataset$race=="Black or African American"&!syntheticdataset$age=="Under 5",sample(colnames(languageblack),1,prob=languageblack/sum(languageblack)),
                     ifelse(syntheticdataset$race=="American Indian or Alaskan Native"&!syntheticdataset$age=="Under 5",sample(colnames(languageAIAN),1,prob=languageAIAN/sum(languageAIAN)),
                            ifelse(syntheticdataset$race=="Asian"&!syntheticdataset$age=="Under 5",sample(colnames(languageasian),1,prob=languageasian/sum(languageasian)),
                                   ifelse(syntheticdataset$race=="Native Hawaiian or Other Pacific Islander"&!syntheticdataset$age=="Under 5",sample(colnames(languageNHPI),1,prob=languageNHPI/sum(languageNHPI)),
                                          ifelse(syntheticdataset$race=="Some Other Race"&!syntheticdataset$age=="Under 5",sample(colnames(languageother),1,prob=languageother/sum(languageother)),
                                                 ifelse(syntheticdataset$race=="Two or More Races"&!syntheticdataset$age=="Under 5",sample(colnames(language2),1,prob=language2/sum(language2)),
                                                        ifelse(syntheticdataset$race=="White"&!syntheticdataset$age=="Under 5",sample(colnames(languagewhite),1,prob=languagewhite/sum(languagewhite)),
                                                               ifelse(syntheticdataset$race=="Hispanic or Latino"&!syntheticdataset$age=="Under 5",sample(colnames(languagehispanic),1,prob=languagehispanic/sum(languagehispanic)),
                                                                      NA))))))))
                                ...
                                ifelse(syntheticdataset$nativity=="Native"&syntheticdataset$English.speaking.skills=="Speaks English less than well",sample(colnames(cbind(native5.17badenglish,native18badenglish)),1,prob=cbind(native5.17badenglish/sum(native5.17badenglish,native18badenglish),native18badenglish/sum(native18badenglish,native5.17badenglish))),
                                       ifelse(syntheticdataset$nativity=="Foreign"&syntheticdataset$English.speaking.skills=="Speaks Only English",sample(colnames(cbind(foreign5.17onlyenglish,foreign18onlyenglish)),1,prob=cbind(foreign5.17onlyenglish/sum(foreign5.17onlyenglish,foreign18onlyenglish),foreign18onlyenglish/sum(foreign18onlyenglish,foreign5.17onlyenglish))),
                                              ifelse(syntheticdataset$nativity=="Foreign"&syntheticdataset$English.speaking.skills=="Speaks English Very Well",sample(colnames(cbind(foreign5.17goodenglish,foreign18goodenglish)),1,prob=cbind(foreign5.17goodenglish/sum(foreign5.17goodenglish,foreign18goodenglish),foreign18goodenglish/sum(foreign18goodenglish,foreign5.17goodenglish))),
                                                     ifelse(syntheticdataset$nativity=="Foreign"&syntheticdataset$English.speaking.skills=="Speaks English less than well",sample(colnames(cbind(foreign5.17badenglish,foreign18badenglish)),1,prob=cbind(foreign5.17badenglish/sum(foreign5.17badenglish,foreign18badenglish),foreign18badenglish/sum(foreign18badenglish,foreign5.17badenglish))),NA)))))
