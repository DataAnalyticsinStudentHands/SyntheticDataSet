...
cart_age_race[,("bgHH_art_match_id"):=
                    paste0(geoid,race,HvL,family,rent_own,hh_age_range_9,as.character(100000+sample(1:.N))),
                  by=.(geoid,race,HvL,family,rent_own,hh_age_range_9)]
...
bgHH_age_race[,("bgHH_at_match_id"):=
                    paste0(geoid,race,hh_age_range_9,rent_own,as.character(100000+sample(1:.N))),
                  by=.(geoid,race,hh_age_range_9,rent_own)]
