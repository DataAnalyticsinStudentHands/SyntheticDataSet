...
#maindir = "~/Documents/Sam_data/" #seeing if OneDrive is culprit
...
if(names(bg_gq_age_data_from_census)[6]=="label_1"){
  ...
  bgGQ <- relabel(bg_gq_age_data_from_census[!is.na(label)],label_c1,row_c1,groupname)
