...
nrow(bgHH_type[hh_age_range_3=="Householder 65 years and over"]) - nrow(cart_age_race[!is.na(hh_type)]) #31037
#then do again for rest
cart_age_race[is.na(hh_type),("bgHH_art_match_id"):=
                    paste0(geoid,family,rent_own,hh_age_range,as.character(100000+sample(1:.N))),
                  by=.(geoid,family,rent_own,hh_age_range)]
bgHH_type[is.na(race),("bgHH_art_match_id"):=
