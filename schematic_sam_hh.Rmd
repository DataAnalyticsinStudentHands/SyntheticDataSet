...
bg_gq_age_data_from_census <- 
  census_block_get(censusdir, vintage, state, censuskey, 
                         ...
                         api_type="dec/dhc",path_suff="est")

total_test <- sum(as.integer(bg_gq_age_data_from_census[label=="!!",6:(ncol(bg_gq_age_data_from_census)-4)],na.rm = TRUE))
bgGQ_age_data <- bg_gq_age_data_from_census[!is.na(label_4)]
...
tr_gq_race_data_from_census <- 
  censusData_byGroupName(censusdir, vintage, state, censuskey, 
                         ...
                         block="tract",api_type="dec/dhc",path_suff="est")
...
#looks like you can make a "family / not family from own_kids, above, and match...
...
#                         block="tract",api_type="dec/dp",path_suff="est")
#
...
#add two together to get bg race, etc.; might need to do the Cartesian thing
...
#                         block="tract",api_type="dec/responserate",path_suff="est")
...
trHH_SARE_data_from_census <- 
  censusData_byGroupName(censusdir, vintage="2020", state, censuskey, 
                         ...
                         block="tract",api_type="dec/dhc",path_suff="est")#api_type="dec/sf1" for 2010
...
group_quarters_block_data_from_census <- 
  censusData_byGroupName(censusdir, vintage="2020", state, censuskey, 
                         ...
                         block="block_group",api_type="dec/dhc",path_suff="est") #api_type="dec/sf1" for 2010
...
group_quarters_tract_type_data_from_census <- 
  censusData_byGroupName(censusdir, vintage="2010", state, censuskey, 
                         ...
                         block="tract",api_type="dec/sf1",path_suff="est")
...
```{r pl data downloaded}
    eth_block_data_from_census <- censusData_byGroupName(censusdir, vintage="2010", state, censuskey, 
                                                                      ...
                                                                      block="block_group",api_type="dec/pl",path_suff="est")
