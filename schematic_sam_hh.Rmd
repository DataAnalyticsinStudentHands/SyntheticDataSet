...
cart_age_eth_fam <- bgHH_age_eth[rep(1:.N,1)][,c("family","indx"):=
                                                   c(list("Family households"),list(1:.N)),
                                                 by=.(geoid,hh_size)] #don't forget to add race in when doing second iteration; may want to get matches from _dec first...
...
#if those work, _dec to age_eth should also give the races on _eth, and give ground truth for family distributions by geoid (tract should work)
