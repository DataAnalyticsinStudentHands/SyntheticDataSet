...
nrow(trHH_race_typesr[!is.na(HvL)]) 
#then H
trHH_race_typesr[is.na(HvL),("trbgHH_typesre1_match_id"):=
                    paste0(tract,alone,sex,as.character(100000+sample(1:.N))),
                  by=.(tract,alone,sex)]
trHH_eth_typesr[is.na(tr_typesr_match),("trbgHH_typesre1_match_id"):=
                    paste0(tract,alone,sex,as.character(100000+sample(1:.N))),
                  by=.(gtract,alone,sex)]
trHH_race_typesr[is.na(HvL),("HvL"):=
                 trHH_eth_typesr[.SD, list(HvL), on = .(trbgHH_typesre1_match_id)]]
trHH_eth_typesr[tr_typesr_match,("tr_typesr_match"):=
...
bgHH_type[is.na(re_code),c("re_code","HvL","sex_sr","alone_sr"):=
                 trHH_race_typesr[.SD, c(list(re_code),list(HvL),list(sex),list(alone)), on = .(trbgHH_typesr1_match_id)]]
...
bgHH_type[is.na(re_code),c("re_code","HvL","sex_sr","alone_sr"):=
                 trHH_race_typesr[.SD, c(list(re_code),list(HvL),list(sex),list(alone)), on = .(trbgHH_typesr2_match_id)]]
...
#then put on _dec, starting with matches from this on race/eth for sr - then the rest...
#cartesian strategy for _dec??
