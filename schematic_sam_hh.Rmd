...
```{r joining after expand for simple cartesian example}
...
cart_trHH_size_eth <- cart_HvL_bgHH_size[rep(1:.N,maxblocks)][,("indx"):=
                                                   list(1:.N),
                                                 by=.(geoid,hh_size)]
trHH_size_eth_maxblocks <- trHH_size_eth[rep(1:.N,6)] #do for all possible geoids / 6 is max number of blocks
...
#could do this with trHH_size_eth 
