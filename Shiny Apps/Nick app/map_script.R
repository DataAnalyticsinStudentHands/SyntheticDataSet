#Carol's Lazy Version of Nicks Script
...
popup=past0("GEOID: ",data_for_map$FIPS,"<br>","# Stroke: ",data_for_map$X..Stroke..2017,"<br>","# Coronary Heart Disease: ",data_for_map$X..Coronary..2017)
