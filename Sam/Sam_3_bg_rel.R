...
#nrow(bg_hhRel[is.na(re_code_14)]) #19999464; only householders matched, under_18 doesn't have sex
...
#SOMETHING'S GONE WRONG BETWEEN HERE AND TIME AFTER REMIX - MAYBE NO REMIX???
...
#matching to tr_hhRelR #screwed up
