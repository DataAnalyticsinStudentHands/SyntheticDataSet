...
vars <- c("B11001_003E","B11001_005E","B11001_006E","B11001_008E","B11001_009E")
col=c("state","county","tract","Married Couple","Male Householder family no wife present","Female Householder family no husband present","Alone","Non-family")
# Get data for all census tracts in TX
census_data <- getCensusApi(acs5_2014_api, key=key, vars, region="for=tract:*&in=state:48")
colnames(census_data)=col

#write data frame to csv file without quotes
write.csv(census_data, file = "household_type_for_error.csv",row.names=FALSE, na="", quote = FALSE)