...
#Load sample set
sample_set=readRDS("complete_sample_set2018-06-20.RDS")
sample_set=sample_set[,c(1:26,43:45)]
#was a mistake in code needs to be fixed in new sample set
sample_set=sample_set[!is.na(sample_set$sex),]
sample_set=sample_set[!is.na(sample_set$age),]
...
#Dont need full sample set anymore it just clogs up memory
rm(sample_set)
