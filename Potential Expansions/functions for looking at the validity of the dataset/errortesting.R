...
run.me.for.errors=function(sampleset){
  ...
  for (county in unique(sampleset$county)){
    ...
    for (tract in tracts){
      ...
      sexbyagebyrace=read.csv(paste0(inputdir,"sex_by_age_by_race.csv"))
      ...
      enrollschool=read.csv(paste0(inputdir,"school_enrollment_by_sex_by_age.csv"))
      ...
      eduattain=read.csv(paste0(inputdir,"education_attainment_by_sex_by_age.csv"))
      ...
      employment=read.csv(paste0(inputdir,"employment.csv"))
      ...
      disability=read.csv(paste0(inputdir,"disability_status.csv"))
      ...
      citizenship.and.language=read.csv(paste0(inputdir,'citizenship_language_for_error.csv'))
      ...
      householdtypeforerror=read.csv(paste0(inputdir,'household_type_for_error.csv'))
      ...
      householdsize=read.csv(paste0(inputdir,"household_size.csv"))
...
#for (seed in 1:10){
seed=1
  source.of.tracts=read.csv(paste0(inputdir,"veteran_status.csv")) #choice of file was arbitrary all files have counties and regions
  a=subset(source.of.tracts,source.of.tracts$county==201)
  tracts=unique(a$tract)
  tracts=c(100000, 210100, 210400)
  ptm<-proc.time()
  sample.set=master(201,tracts,1,seed)
  print(proc.time() - ptm)
  warnings()
