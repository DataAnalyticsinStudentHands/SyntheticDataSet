...
vars <- c(c(group.quarters.population,
            ...
            same.house.70.to.74,
            same.house.over.75,
            moved.within.county.men,
            moved.within.county.women,
            moved.within.county.black,
            moved.within.county.amer.indian.alaskan,
            moved.within.county.asian,
            moved.within.county.islander,
            moved.within.county.other,
            moved.within.county.multiracial,
            moved.within.county.white,
            moved.within.county.hispanic,
            ...
            moved.within.county.total,
            moved.within.state.men,
            moved.within.state.women,
            moved.within.state.black,
            moved.within.state.amer.indian.alaskan,
            moved.within.state.asian,
            moved.within.state.islander,
            moved.within.state.other,
            moved.within.state.multiracial,
            moved.within.state.white,
            moved.within.state.hispanic,
            ...
            moved.within.state.total,
            out.of.state.men,
            out.of.state.women,
            out.of.state.black,
            out.of.state.amer.indian.alaskan,
            out.of.state.asian,out.of.state.islander,
            out.of.state.other,
            out.of.state.multiracial,
            out.of.state.white,
            ...
            out.of.nation.women,
            out.of.nation.black,
            out.of.nation.amer.indian.alaskan,
            out.of.nation.asian,
            out.of.nation.islander,
            out.of.nation.other,
            out.of.nation.multiracial,
            out.of.nation.white,
            out.of.nation.hispanic,
...
saveRDS(census_data,"Census_data_2015.RDS")
