...
```{r expand P28 into dec_bgHHr_10 and dec_bgHHe_10}
    ...
    paste0("Column names for dec_bgHHr_10: ",colnames(dec_bgHHr_10))
    ...
    paste0("Column names for dec_bgHHe_10: ",colnames(dec_bgHHe_10))
    #clean up
    rm(dec_bgHH_data_10)
...
We quickly see that H18 needs some of the information from P18 to actually join correctly with P22, above. Let's just join them into one HHr_type file
...
check_summary <- census_table_check(dec_bgHH_type_data_10, "HOUSEHOLD TYPE","households") #should get a function that fails appropriately
cat(check_summary[1])
```
...
check_summary <- census_table_check(dec_bgHH_avg_size_data_10, "AVERAGE HOUSEHOLD SIZE BY AGE","households") #should get a function that fails appropriately
cat(check_summary[1])
```
